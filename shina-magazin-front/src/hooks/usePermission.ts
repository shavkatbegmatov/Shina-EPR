 ...
 */
// Ruxsat kodlari alohida modulda (config/permissions.ts); shu yerdan qayta eksport —
// mavjud import'lar (`from '@/hooks/usePermission'`) o'zgarmaydi.
export { PermissionCode, type PermissionCodeType } from '../config/permissions';
