...
export const PermissionCode = {
  ...
  // TRADE_INS — barter (eski shinani qabul qilish); CANCEL faqat rahbariyatda
  TRADE_INS_VIEW: 'TRADE_INS_VIEW',
  TRADE_INS_CREATE: 'TRADE_INS_CREATE',
  TRADE_INS_CANCEL: 'TRADE_INS_CANCEL',
