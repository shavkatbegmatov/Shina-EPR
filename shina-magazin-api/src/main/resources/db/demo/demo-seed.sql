...
WITH catalog(brand_name, category_name, sku, name, width, profile, diameter,
    ...
    ('Nordway','Yengil avtomobil shinalari','DEMO-NDW-FRS-2255017','Nordway FrostLine 225/50 R17',225,50,17,'98','T','WINTER',920000::numeric,1290000::numeric,4,5,'Qishki magistral uchun yo''nalishli protektor va suv chiqarish kanallari.','/products/demo/winter.webp'),
    ...
    ('Veloce','Yengil avtomobil shinalari','DEMO-VLC-TRK-2553520','Veloce TrackOne 255/35 R20',255,35,20,'97','Y','SUMMER',1980000::numeric,2790000::numeric,4,4,'Flagman UHP model: quruq asfaltda maksimal tutashuv.','/products/demo/sport-uhp.webp'),
    ...
    -- quantity kamida sotilgan miqdorcha bo'lishi kerak: S-011 (10) + W-005 (8)
    ('CargoMax','Yuk mashinasi shinalari','DEMO-CGM-TRN-2257015','CargoMax TransitPro 225/70 R15C',225,70,15,'112','S','ALL_SEASON',980000::numeric,1370000::numeric,20,5,'Furgonlar uchun kuchaytirilgan karkas va barqaror magistral protektori.','/products/demo/commercial.webp'),
